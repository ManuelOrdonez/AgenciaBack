...
namespace AgenciaDeEmpleoVirutal.UnitedTests.CallHistoryTraceBlTest
{
    ...
    [TestClass]
    public class GetAllCallsNotManagedTest : CallHistoryTraceTestBase
    {
        ...
        public void GetCallInfo_WhenSessionIdIsNullOrEmptyReturnError()
        {
            ...
            //Action
            var result = CallHistoryTraceBusiness.GetAllCallsNotManaged(OpenTokSessionId,
                CallStateCode.Managed.ToString());
            //Assert
        ...
        public void GetUserInfo_WhenCallReturnSuccess()
        {
            ...
            .Returns(Task.FromResult(new List<CallHistoryTrace> { CallHistoryTraceEntity, CallHistoryTraceEntity })); 
            var expected = ResponseSuccess(new List<CallHistoryTrace>());
            //Action
            var result = CallHistoryTraceBusiness.GetAllCallsNotManaged(OpenTokSessionId, CallStateCode.Managed.ToString());
            //Assert
